...
Go here to change your email: <?php echo 'http://gw2.3hoursdungeon.com/UserProfiles/changeEmail?username='.$this->request->data['User']['username'].'&key='.$this->request->data['User']['hash'].'&email='.$this->data['changeEmail']['email']; ?>